export const queryKeys = {
  ...
  admin: {
    ...
    technologyDetail: (id: number) => ['admin', 'technologies', id] as const,

    cvProfiles: ['admin', 'cv-profiles'] as const,
    cvProfileDetail: (id: number) => ['admin', 'cv-profiles', id] as const,

    experiences: ['admin', 'experiences'] as const,
    experienceDetail: (id: number) => ['admin', 'experiences', id] as const,

    certificates: ['admin', 'certificates'] as const,
    certificateDetail: (id: number) => ['admin', 'certificates', id] as const,
    ...
    englishPlanDetail: (id: number) => ['admin', 'english-plans', id] as const,

    learningRoadmaps: ['admin', 'learning-roadmaps'] as const,
    learningRoadmapDetail: (id: number) => ['admin', 'learning-roadmaps', id] as const,
  },
} as const;
